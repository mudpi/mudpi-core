...
class SensorTrigger(Trigger):
	...
	def __init__(self, main_thread_running, system_ready, name='SensorTrigger',key=None, source=None, thresholds=None, channel="sensors", trigger_active=None, frequency='once', actions=[]):
