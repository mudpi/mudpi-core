...
from mudpi.workers.linux.worker import Worker
from mudpi.logger.Logger import Logger, LOG_LEVEL
from mudpi.controls.linux.button_control import (ButtonControl)
from mudpi.controls.linux.switch_control import (SwitchControl)
...
class LinuxControlWorker(Worker):
    def __init__(self, config, main_thread_running, system_ready):
        ...
        self.topic = self.config.get('topic', 'controls')
