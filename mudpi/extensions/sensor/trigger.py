""" 
    Sensor Trigger Interface
    Monitors sensor state changes and 
...
class Interface(BaseInterface):
    ...
    def load(self, config):
        """ Load sensor Trigger component from configs """
        trigger = SensorTrigger(self.mudpi, config)
        if trigger:
...
class SensorTrigger(Trigger):
    """ A trigger that listens to sensor
