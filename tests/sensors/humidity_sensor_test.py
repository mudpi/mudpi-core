...
class HumiditySensor(Sensor):
	...
	def __init__(self, pin, name='HumdityTempSensor', key=None):
	...
	def read(self):
		...
		print("Temperature: %d C" % value.temperature)
		print("Humidity: %d %%" % value.humidity)
		print(value)
		if value.is_valid():
			r.set(self.key + '_temperature', value.temperature)
			r.set(self.key + '_humidity', value.humidity)
			readings = {'temperature': value.temperature, 'humidity': value.humidity}
			#r.set(self.key, readings)
			print(readings)
			return value
...
if __name__ == '__main__':
	try:
		...
		print('Humid/Temp Sensor Closing...')